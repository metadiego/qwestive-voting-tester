...
exports.getProgramId = exports.getKeypair = exports.getPrivateKey = exports.getPublicKey = exports.establishConnection = exports.logError = void 0;
var web3_js_1 = require("@solana/web3.js");
var fs = require("fs");
var logError = function (msg) {
    console.log("\u001B[31m".concat(msg, "\u001B[0m"));
};
...
function establishConnection() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connection = new web3_js_1.Connection(DEV_NET_URL, 'confirmed');
...
var getPrivateKey = function (name) {
    return Uint8Array.from(JSON.parse(fs.readFileSync("./keys/".concat(name, "_private.json"))));
};
